...
// GraphQL HTTP URL
const API_URL = 'http://localhost:4000/graphql'; // process.env.REACT_APP_API_URL;

// GraphQL WebSocket (subscriptions) URL.
// If its url is not set in .env then it has same url, host and pathname
const WEBSOCKET_API_URL = 'ws://localhost:4000/graphql'; //process.env.REACT_APP_WEBSOCKET_API_URL;
